...
/**
 * Genetic code table for bacterial, plant plastid, and chloroplast translation.
 */
public class TheBacterialPlantPlastidCode extends GeneticCode{
	...
	public TheBacterialPlantPlastidCode() {
