...
/**
 * Standard genetic code table (NCBI translation table 1) for nuclear translation.
 */
public class TheStandardCode extends GeneticCode{

	String[] tripletNNs_aas = { "TTT F", "TCT S", "TAT Y", "TGT C", "TTC F", "TCC S", "TAC Y", "TGC C", "TTA L", "TCA S",
